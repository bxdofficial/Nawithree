// Official Social Media Brand Icons Component
...
export const GmailIcon = ({ className = "w-6 h-6", ...props }) => (
  <svg className={className} viewBox="0 0 24 24" fill="currentColor" {...props}>
...
export const WebsiteIcon = ({ className = "w-6 h-6", ...props }) => (
  <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
...
export const GoogleIcon = ({ className = "w-6 h-6", ...props }) => (
...
// Social link component with proper styling
export const SocialLink = ({ href, platform, className = "", ariaLabel }) => {
  return (
    <a
      href={href}
      target="_blank"
      rel="noopener noreferrer"
      className={`inline-flex items-center justify-center p-2 rounded-lg transition-all duration-200 hover:scale-110 ${className}`}
